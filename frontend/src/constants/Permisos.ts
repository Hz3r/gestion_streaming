...
export const GRUPOS_PERMISOS = [
    ...
    { nombre: 'Contratos', prefijo: 'contratos:' },
    { nombre: 'Cuentas Streaming', prefijo: 'cuentas:' },
    { nombre: 'Lank (Granja)', prefijo: 'lank:' },
    { nombre: 'Finanzas', prefijo: 'finanzas:' },
    { nombre: 'Administración', prefijo: 'usuarios:|roles:' },
];
